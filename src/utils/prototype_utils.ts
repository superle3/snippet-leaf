...
if (Set.prototype.difference) {
    ...
    difference_proto = <T>(a: Set<T>, b: Set<T>) =>
        difference.call(a, b) satisfies Set<T> as Set<T>;
}
if (Set.prototype.intersection) {
    const intersection = Set.prototype.intersection;
    intersection_proto = <T>(a: Set<T>, b: Set<T>) =>
        intersection.call(a, b) satisfies Set<T> as Set<T>;
}
