...
import {
    ...
    onFileChange,
    onFileDelete,
    getSnippetsFromFiles,
    getFileSets,
    getVariablesFromFiles,
    tryGetVariablesFromUnknownFiles,
} from "./settings/file_watch";
import {
...
export default class LatexSuitePlugin extends Plugin {
    ...
    async loadSettings() {
        ...
        if (
            ...
            const tempSnippets =
                await this.getSettingsSnippets(tempSnippetVariables);
